...
2. 请先自行通过Google/[Github](https://github.com/jdsids98/shadowsocks-heroku/search?utf8=%E2%9C%93&q=&type=)寻找答案
...
注册地址：https://signup.heroku.com/ （注册和部署过程可能需要梯子[#10](https://github.com/jdsids98/shadowsocks-heroku/issues/10)，[#14](https://github.com/jdsids98/shadowsocks-heroku/issues/14)）

## 部署
1. 点击 [![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/jdsids98/shadowsocks-heroku/tree/re)，[一键部署到heroku](https://heroku.com/deploy?template=https://github.com/jdsids98/shadowsocks-heroku/tree/re)
...
## 启动本地 Client
1. 下载release https://github.com/jdsids98/shadowsocks-heroku/releases （[备份](https://github.com/jdsids98/archive/tree/master/tool)）

2. 修改config.json参数，运行ss-h.exe 或 start.vbs (或 [win托盘工具taskbar.exe](https://github.com/jdsids98/shadowsocks-heroku/issues/39))

5. 启动成功，命令行显示：`server listening at { address: '127.0.0.1', family: 'IPv4', port: 1080 }`

## 配置代理
1. 下载：Chrome 浏览器 [SwitchyOmega](https://github.com/FelisCatus/SwitchyOmega/releases) 插件（[参考教程](https://github.com/FelisCatus/SwitchyOmega/wiki/GFWList), 导入备份文件[SSHeroku.Bak.zip](https://github.com/jdsids98/shadowsocks-heroku/files/1371313/SSHeroku.zip)）
